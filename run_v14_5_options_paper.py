"""Paper entrypoint for V14.5 stable-direction option trading.

Uses the V14.4 session-aware warm-start feature engine and the V14.5
CALL/PUT debit-spread trader. Live trading remains disabled.
"""
...
from strategy.v14_5_stable_options import create_v14_5_stable_options_trader
from strategy.warm_start_v14_4 import SessionWarmFeatureEngine


def main() -> int:
    parser = argparse.ArgumentParser(description="V14.5 stable Alpaca paper options")
    ...
    print("=" * 86)
    print("V14.5 STABLE OPTIONS + V14.4 ZERO-WAIT WARM START")
    ...
    try:
        ...
        trader = create_v14_5_stable_options_trader(
            args.symbol,
